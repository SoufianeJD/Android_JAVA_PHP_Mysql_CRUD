...
public class AddAdmin extends AppCompatActivity {
    ...
    Button btn1;
    EditText  nom, prenom, bureau, poste, description,email;
    String   Nom, Prenom, Bureau, Poste, Description,Email;
...
//si la previous condition et valid , on envoie un string request pr recupérer le lien contenant le script php
                if (valid) {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, ConnectionToScripts.URL_addadmin, new Response.Listener<String>() {
                        @Override
                        ...
                        public void onErrorResponse(VolleyError error) {
                            progressDialog.hide();
                            Toast.makeText(AddAdmin.this, "Failed ! you're not welcome yet...", Toast.LENGTH_SHORT).show();
                        }
                    }) {
                    ...
                    RequestHandler.getInstance(AddAdmin.this).addToRequestQueue(stringRequest);
